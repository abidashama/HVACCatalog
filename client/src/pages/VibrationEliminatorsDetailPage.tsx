...
const toTitleCase = (str: string): string => {
  ...
  const acronyms = ['hvac', 'ac', 'dc', 'ul', 'ce', 'sva']
...
export default function VibrationEliminatorsDetailPage() {
  const [, params] = useRoute('/vibration-eliminators/:subcategoryId')
  ...
  const categories = vibrationEliminatorsData.categories as Record<string, SubcategoryData>

  // Map subcategory IDs to data
  const subcategoryMap: Record<string, SubcategoryData> = {
    'vibration-eliminators': categories.vibrationEliminators
  }
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="flex justify-center mt-6">
            <Button onClick={() => setLocation(VIBRATION_ELIMINATORS_URL)}>
  ...
  return (
    <div className="min-h-screen bg-slate-50 relative overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 relative z-10">
        <Button
          variant="ghost"
          onClick={() => setLocation(VIBRATION_ELIMINATORS_URL)}
          ...
          <div className="space-y-8" ref={productInfoRef}>
            <div>
              <div className="flex items-center gap-3 mb-4">
                <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200 px-3 py-1 text-sm">Vibration Eliminators</Badge>
              </div>
